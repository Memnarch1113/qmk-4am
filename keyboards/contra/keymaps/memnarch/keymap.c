 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  |   \  | To 0 |    Space    | To 1 | Left | Right|  Up  |Down  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_LCTL, KC_LALT, KC_LGUI, KC_BSLS, TO(0),   KC_SPC,  KC_SPC,  TO(1),   KC_LEFT, KC_RIGHT, KC_UP,  KC_DOWN}
},
...
//   {BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, To(0),   KC_SPC,  To(1),  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
// },
