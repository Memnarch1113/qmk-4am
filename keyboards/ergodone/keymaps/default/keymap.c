...
[BASE] = LAYOUT_ergodox( \
  KC_F1,      KC_F2,     KC_GRAVE,     KC_1,       KC_2,          KC_3,          KC_4,         KC_5,
  ...
  KC_U,      KC_I,       KC_O,         KC_P,       KC_LBRACKET,   KC_RBRACKET,   KC_BSLASH,    KC_PGUP,
  KC_H,      KC_J,       KC_K,         KC_L,       KC_SCOLON,     KC_QUOTE,      KC_ENTER,     KC_PGDOWN,
  KC_N,      KC_M,       KC_COMMA,     KC_DOT,     KC_SLASH,      KC_RSHIFT,     KC_UP,        KC_END,
